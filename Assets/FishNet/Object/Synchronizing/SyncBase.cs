...
namespace FishNet.Object.Synchronizing.Internal
{
    public class SyncBase : ISyncType
    {
        ...
        /// </summary>
        public ushort SyncIndex { get; protected set; } = 0;
        #endregion
        ...
        public void InitializeInstanceInternal(WritePermission writePermissions, ReadPermission readPermissions, float tickRate, Channel channel, bool isSyncObject)
        {
        ...
        public void SetSyncIndexInternal(NetworkBehaviour nb, ushort index)
        {
            NetworkBehaviour = nb;
            SyncIndex = index;
            NetworkBehaviour.RegisterSyncTypeInternal(this, SyncIndex);
        }
