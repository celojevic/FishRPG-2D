...
namespace FishNet.Object
{
    ...
    public abstract partial class NetworkBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        private Dictionary<ushort, SyncBase> _syncVars = new Dictionary<ushort, SyncBase>();
        /// <summary>
        ...
        /// SyncVars within this NetworkBehaviour.
        /// </summary>
        private Dictionary<ushort, SyncBase> _syncObjects = new Dictionary<ushort, SyncBase>();
        /// <summary>
        ...
        public void RegisterSyncTypeInternal(SyncBase sb, ushort index)
        {
            if (sb.IsSyncObject)
        ...
        /// <param name="reader"></param>
        /// <param name="index"></param>
        public virtual void ReadSyncVarInternal(PooledReader reader, byte index) { } 
        ...
        internal bool WriteDirtySyncTypes(bool isSyncObject)
        {
            ...
            Dictionary<ushort, SyncBase> collection = (isSyncObject) ? _syncObjects : _syncVars;
        ...
        internal void WriteSyncTypesForSpawn(PooledWriter writer, bool forOwner)
        {
            ...
            void WriteSyncType(Dictionary<ushort, SyncBase> collection)
            {
