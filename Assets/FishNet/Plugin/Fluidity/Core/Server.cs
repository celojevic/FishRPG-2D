    ...
    public class ServerSocket
    {
        ...
        public void StopConnection(int connectionId, bool immediately)
        {
            ...
            if (!immediately)
            {
                ...
                {
                    Type = CommandTypes.DisconnectPeer,
            ...
            else
            {
                try
                {
                    ...
                    _peers[connectionId].DisconnectNow(0);
        ...
        private void DequeueCommands()
        {
            ...
            {
                if (command.Type == CommandTypes.DisconnectPeer)
        ...
        private void EnqueIncomingPacket(ENet.Event enetEvent)
        {
        ...
        public void IterateIncoming()
        {
            ...
            while (_incoming.TryDequeue(out IncomingPacket incoming))
            {
                ...
                //_transport.HandleServerReceivedDataArgs(
                    //new ServerReceivedDataArgs(data, (Channel)incoming.Channel, (int)incoming.ConnectionId)
                    //);
                //_transport.HandleReceivedDataArgs(_receivedDataArgs);
                //Cleanup enet packet.
