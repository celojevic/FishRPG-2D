...
namespace FishNet.Utilities.Objects
{
    ...
    public static class Transforms
    {
        ...
        public static void GetComponentsInChildren<T>(Transform parent, List<T> results, bool includeParent = true, bool includeInactive = false) where T : UnityEngine.Component
        {
            if (!includeParent)
            {
